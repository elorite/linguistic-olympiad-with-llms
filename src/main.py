...
if __name__ == "__main__":
    ...
    if strategy_to_use == "zero-shot": strat = zero_shot
    elif strategy_to_use == "chain-of-thought": strat = cot_linguistic
    else: strat = zero_shot
    
    # Test
    print(f"Running {strategy_to_use} strategy...\n")
    for problem in test_problems:
        ...
        for q_raw in problem['questions']:
            ...
            # Sleep to respect the API rate limits (we can do 30 requests per minute and 14.400 per day with gemma27b)
            time.sleep(5)
